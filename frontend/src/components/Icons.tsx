...
export const SaveIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 21a1.5 1.5 0 001.5-1.5V6.75a1.5 1.5 0 00-.44-1.06l-4.75-4.75A1.5 1.5 0 0014.75 0H4.5A1.5 1.5 0 003 1.5v18a1.5 1.5 0 001.5 1.5h15z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 21V15a1.5 1.5 0 00-1.5-1.5H9a1.5 1.5 0 00-1.5 1.5v6" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 1.5v4.5a1.5 1.5 0 001.5 1.5h6a1.5 1.5 0 001.5-1.5V1.5" />
    </svg>
);
...
export const LogoutIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15M18 12l3-3m0 0l-3-3m3 3H9" />
    </svg>
);
