...
# Step 2: Build aggregation pipeline
    ...
    for d in translation_docs:
        ...
        if object_id:
            obj = await objects_collection.find_one({"_id": object_id}, {"_id": 0, "image_name": 1, "sequence_number": 1, "image_base64": 1})
            if obj:
                ...
                print(f"Hint: {api_pic.result.object_hint_en}, Description: {api_pic.result.object_description_en}")
